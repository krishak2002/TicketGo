	...
	<div class="main-content">
					...
					<ul class="nav" id="side-menu">
						...
						<li>
							<a href="addshows.jsp" ><i class="fa fa-th-large nav_icon"></i>Add Shows</a>							
                                                ...
                                                <li>
							<a href="viewshows.jsp" class="active"><i class="fa fa-th-large nav_icon"></i>View Shows</a>							
						</li>
		...
		<!-- main content start-->
                <div id="page-wrapper">
                    ...
                    -->
                    <div id="d1"  style="background-color: #4F52BA;padding: 10px; margin: 5px ; color: white  ">
                ...
                <table class="table ">
                    ...
                    <%
                        try
                        {
                            ...
                            ResultSet rs=DBLoader.executeSQL("Select * from shows");
                            while(rs.next())
                            {
                                 int id=rs.getInt("id");
                                 int movieid=rs.getInt("movie");
                                 int multiplexid=rs.getInt("multiplex");
                                 int screenid=rs.getInt("screens");
